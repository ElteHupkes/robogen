 ...
 * @(#) $Id$
 */
#ifndef SDFB_CORE_COMPONENTMODEL_H_
#define SDFB_GZ_CORE_COMPONENTMODEL_H_

#include "gazebo/model/PerceptiveComponent.h"
...
public:
	 ...
	 */
	CoreComponentModel(std::string id, bool hasSensors);
...
#endif /* SDFB_CORE_COMPONENTMODEL_H_ */
